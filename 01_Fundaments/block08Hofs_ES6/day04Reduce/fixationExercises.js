...
const teste = () =>
  obj.materias.reduce((finalObj, currObj) => (
    (currObj.nota > finalObj.nota)
      ? currObj
      : finalObj
  ));
...
const getStudentHighestScore = () =>
  estudantes.map((estudante) => ({
    name: estudante.nome,
    materia: estudante.materias.reduce((finalObj, currObj) =>
      (currObj.nota > finalObj.nota)
        ? currObj
        : finalObj
    ).name
...
console.log(getStudentHighestScore())
